...
<body>
            ...
            <tr>
                ...
                <td style="width: 30%; text-align: right; vertical-align: middle;">
                    <div style="line-height: 1.6; font-size: 13px;">
                        <strong style="font-size: 18px; text-transform: uppercase;">ASSESSMENT</strong><br>
    ...
    @foreach ($titles as $i => $title)
        <table class="assessment-entry">
            <tr>
                <!-- Image -->
                <td class="assessment-image">
                ...
                <td class="assessment-text">
                    <div class="assessment-title">{{ ucfirst($title) }}</div>
                    <span class="underline"></span>
                    <div class="assessment-description">{{ $descriptions[$i] ?? '' }}</div>
                </td>
            </tr>
        </table>
    @endforeach
