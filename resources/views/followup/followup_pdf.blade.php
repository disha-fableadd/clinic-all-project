...
<body>
    <div class="page-border">
                ...
                <tr>
                    ...
                    <td style="width: 30%; text-align: right; vertical-align: middle;">
                        <div style="line-height: 1.6; font-size: 13px;">
                            <strong style="font-size: 20px; text-transform: uppercase;">FOLLOWUP</strong><br>
        ...
        <div class="section">
            ...
            @if($currentProjectTypeId !== 3)
            <p><strong>Type:</strong> {{ ucfirst($followup->followup_type) ?? '--' }}</p>
            <p><strong>Update:</strong> {{ $followup->followup_update ?? '--' }}</p>
            @endif
        </div>
