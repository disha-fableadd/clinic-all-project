    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row" style="padding-top:15px">
                <div class=" col-6">
                    <h4 class="page-title  therapy-title">Edit Therapy</h4>
                </div>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <form id="edittherapyForm" method="POST" class="form-container all-form therapy-form">

                        @csrf

                        <div class="row">
                            <input type="hidden" id="therapyId" value="{{ $therapy_id ?? '' }}">
                        ...
                        <div id="edittherapysuccessMessage" class="alert alert-success" style="display:none;"></div>
                        {{-- <div id="edittherapyerrorMessage" class="alert alert-danger" style="display:none;"></div> --}}
